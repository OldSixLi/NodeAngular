    ...
    "Evaluation Version": {
      ...
      "data": {
        "dataTable": {
          "1": {
            "1": {
              "value": "西安葡萄城Spread.Sheets提供技术支持。"
            }
          },
          "2": {
            "1": {
              "value": "本评估版本仅限本地设计器。临时设计器许可仅限测试用途。"
            }
          },
          "3": {
            "1": {
              "value": "详情咨询请发送邮件到sales.xa@grapecity.com。"
            }
          }
        }
      },
      ...
      "data": {
        "dataTable": {
          ...
          "18": {
            ...
            "2": {
              "value": "此纳税申报表是根据《中华人民共和国房产税暂行条例》和国家有关税收规定填报的，是真实的、可靠的、完整的。",
              "style": {
                "backColor": "#a6caf0",
                "foreColor": "#000000",
                "hAlign": 1,
